            ...
            bannerTable = $('#bannerTable').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            let html = "";
                            html += "<a class='delete' href='" + BASE_URL + "/admin/banners/" +
                                row.id +
                                "/edit'><i class='fa fa-edit'></i></a>"
                            html +=
                                "<button type='submit' class='delete' style='border:0px;' onclick='deleteZone(\"" +
                                row.id +
        ...
        function deleteZone(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var userURL = BASE_URL + "/admin/banners/" + id;
        ...
        function toggleZone(id, status) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var userURL = BASE_URL + "/admin/toggle-banner/" + id;
                    $.ajax({
                        url: userURL,
                        type: "GET",
                        dataType: "json",
