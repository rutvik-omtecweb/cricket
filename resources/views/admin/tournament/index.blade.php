        ...
        $(document).ready(function() {
            tournamentTable = $('#tournamentTable').DataTable({
                ...
                ajax: {
                    processing: true,
                    serverSide: true,
                    url: "{{ route('admin.get.tournaments') }}",
                },
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            let html = "";
                            html += "<a class='delete' href='" + BASE_URL + "/admin/tournaments/" +
                                row.id +
        ...
        function deleteTournament(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var userURL = BASE_URL + "/admin/tournaments/" + id;
        ...
        function toggleTournament(id, status) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var userURL = BASE_URL + "/admin/toggle-tournaments/" + id;
                    $.ajax({
                        url: userURL,
                        type: "GET",
                        dataType: "json",
