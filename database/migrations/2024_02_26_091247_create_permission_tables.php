...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            $table->uuid('id')->default(\Illuminate\Support\Str::uuid())->primary(); // permission id
        ...
        Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams, $columnNames) {
            $table->uuid('id')->default(\Illuminate\Support\Str::uuid())->primary(); // role id
        ...
        Schema::create($tableNames['role_has_permissions'], function (Blueprint $table) use ($tableNames) {
            ...
            $table->primary(['permission_id', 'role_id'], 'model_has_roles_role_model_type_primary');
        });
